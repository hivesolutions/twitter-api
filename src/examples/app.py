...
class TwitterApp(appier.WebApp):
    ...
    def __init__(self, *args, **kwargs):
        appier.WebApp.__init__(self, name="twitter", *args, **kwargs)
    ...
    def delete(self):
        if "tw.oauth_token" in self.session:
            del self.session["tw.oauth_token"]
        if "tw.oauth_token_secret" in self.session:
            del self.session["tw.oauth_token_secret"]
        if "tw.oauth_temporary" in self.session:
